...
Readonly my $RANK_TWO   => 2;
Readonly my $RANK_THREE => 3;
...
my $top_three_energy = 0;
$top_three_energy += determine_energy_for_rank( $elves, $RANK_ONE );
$top_three_energy += determine_energy_for_rank( $elves, $RANK_TWO );
$top_three_energy += determine_energy_for_rank( $elves, $RANK_THREE );
print sprintf "%d\n", $top_three_energy;
